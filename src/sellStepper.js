...
import CreateXBORDER from "./views/Components/CreateContract.js";
...
function getStepContent(step,handleChange) {
  switch (step) {
    case 0:
      return <div><h5>Find a trader looking to buy ETH through Paypal on: <ul><li><Link to="//www.reddit.com/r/XBORDER/">XBORDER subreddit</Link></li><li><Link to="//t.me/XBORDER/">XBORDER Telegram group</Link></li></ul></h5> 
       {/* <Input2/> */}
       </div>;
    case 1:
      return <div><PaypalInvoiceStepper/></div>;
    case 2:
      return <div><CreateXBORDER createHandler={onContractCreation} toggleNextEnabled={handleChange}/></div>;
    case 3:
      return <div><InteractContract newXBORDERAddress={newXBORDERAddress} newOracleCount={newOracleCount}/></div>;
    case 4:
